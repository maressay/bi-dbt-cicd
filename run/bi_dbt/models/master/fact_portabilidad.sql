    ...
    USE [DB_BI];
    EXEC('
        create view "master"."fact_portabilidad__dbt_tmp__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "DB_BI"."master"."fact_portabilidad__dbt_tmp" FROM "DB_BI"."master"."fact_portabilidad__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS master.fact_portabilidad__dbt_tmp__dbt_tmp_vw')
